...
<form class="form-horizontal" method="post" action="<?php echo U('Teacher/Problem/addprogram');?>" onSubmit="return chkexam(this)">
	...
	<div class="form-group">
		...
		<?php if(isset($answernumC) and $answernumC > 0): if(is_array($ansrow)): foreach($ansrow as $k=>$ar): ?><div class="col-md-4" id="divans<?php echo ($k+1); ?>">
				<input type="text" class="form-control" 
				name="answer<?php echo ($k+1); ?>" id="answer<?php echo ($k+1); ?>" value="<?php echo ($ar['question_id']); ?>">
				</div><?php endforeach; endif; endif; ?>
		</div>
	</div>

	<input type="hidden" name="numanswer" id="numanswer" value="<?php echo ((isset($answernumC) && ($answernumC !== ""))?($answernumC):0); ?>">
