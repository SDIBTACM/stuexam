	...
	<table class="table table-hover table-bordered table-condensed">
		...
		<tbody>
			<?php if(is_array($row)): foreach($row as $k=>$r): ?><tr>
					...
					<td align='left'><a href="<?php echo U('Teacher/Add/choose',array('id'=>$r['choose_id']));?>"><?php echo (cutstring($r['question'])); ?>...</a>
					...
					<?php if(isset($added[$r['choose_id']]) and $added[$r['choose_id']] > 0): ?><td>已添加</td>
					<?php else: ?>
					<td><a href="##" onclick="addtoexam(this,<?php echo ($eid); ?>,<?php echo ($r['choose_id']); ?>,1)">添加到试卷</a></td><?php endif; ?>
