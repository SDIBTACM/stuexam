	...
	<form class='form-horizontal' method="post" action="<?php echo U('Teacher/Add/choose');?>" onSubmit="return chkchoose(this)">
		...
		<div class="form-group">
			...
			<select class='form-control' name="easycount" id="easycount">
				<?php $__FOR_START_1542339902__=0;$__FOR_END_1542339902__=11;for($i=$__FOR_START_1542339902__;$i < $__FOR_END_1542339902__;$i+=1){ if(isset($row['easycount']) and $row['easycount'] == $i): ?><option value="<?php echo ($i); ?>" selected><?php echo ($i); ?></option>
					<?php else: ?>
