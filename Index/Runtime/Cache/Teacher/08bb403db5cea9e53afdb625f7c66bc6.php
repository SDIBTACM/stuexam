...
<div class="container exam_content">
	...
	<div class='row'>
		...
		<div class='col-md-2'>
			<h1><a href="<?php echo U('Teacher/Add/judge',array('page'=>$mypage['page']));?>" class='btn btn-info'>添加判断题</a></h1>
		</div>
		<div class="col-md-2">
	...
	<table class="table table-hover table-bordered table-condensed">
		...
		<tbody>
			<?php if(is_array($row)): foreach($row as $k=>$r): ?><tr>
					...
					<td><a href="javascript:suredo('<?php echo U('Teacher/Del/judge',array('id'=>$r['judge_id'],'getkey'=>$mykey,'page'=>$mypage['page']));?>','确定删除?')">删除</a></td>
					<td><a href="<?php echo U('Teacher/Add/judge',array('id'=>$r['judge_id'],'page'=>$mypage['page']));?>">编辑</a></td>
				</tr><?php endforeach; endif; ?>
		</tbody>
	</table>
	<?php echo (showpagelast($mypage,U("Teacher/Index/judge"),"search=$search&problem=$problem")); ?>
</div>
<script>
$(function(){
